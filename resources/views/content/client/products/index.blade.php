...
@section('content')
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#largeModal2"><i
                                            class="mdi mdi-trash-can-outline me-1"></i>Product Request Form </a>
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#largeModal2"><i
                                            class="mdi mdi-trash-can-outline me-1"></i>Product Request </a>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="modal fade" id="largeModal2" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel3">Product Request Form</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="modal-footer">
                    ...
                    <form>
                        ...
                        <div class="input-group input-group-merge mb-4 mt-2">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                    class="mdi mdi-account-outline"></i></span>
                            <input type="text" class="form-control pl-3 toggle-input" style="padding-left: 12px;"
                                disabled id="basic-icon-default-fullname" placeholder="Product Name" value="Product Name"
                                aria-label="Product Name" aria-describedby="basic-icon-default-fullname2" />
                        </div>
                        ...
                        <div class="input-group input-group-merge mb-4">
                            ...
                            <input type="text" class="form-control toggle-input" style="padding-left:12px;" disabled
                                id="date-range-picker" placeholder=" Shipping Address" value="Shipping Address">
                        </div>

                        <div class="input-group input-group-merge mb-4">
                            <span id="basic-icon-default-phone2" class="input-group-text"><i
                                    class="mdi mdi-calculator-variant-outline"></i></span>
                            <input type="text" id="basic-icon-default-phone" style="padding-left:12px;" disabled
                                class=" form-control toggle-input phone-mask" placeholder="Special Instructions"
                                aria-label="Quantity" value="Special Instructions"
                                aria-describedby="basic-icon-default-phone2" />
                        </div>
                        {{-- <div class="input-group input-group-merge mb-4">
                            <span id="basic-icon-default-message2" class="input-group-text"><i
