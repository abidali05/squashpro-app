...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="py-3"><span class="text-muted fw-medium">Seasons</span>
            </h4>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <label for="orderIdFilter" class="form-label">From</label>
                    <input type="date" id="orderIdFilter" class="form-control" placeholder="Search by Order ID">
                </div>
                <div class="col-md-4">
                    <label for="orderIdFilter" class="form-label">To</label>
                    <input type="date" id="orderIdFilter" class="form-control" placeholder="Search by Order ID">
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="contractDetailsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Breeding Season Filter </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                            ...
                            <div class="contract-content mb-4 p-3 border rounded bg-light">
                                ...
                                <div id="signedInfo" class="mt-4 d-none">
                                    ...
                                    <div class="signature-display">
                                        <p class="mb-1"><strong>Signature:</strong> <span id="signedDate"></span> </p>
