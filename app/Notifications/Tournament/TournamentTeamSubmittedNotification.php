...
class TournamentTeamSubmittedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'title' => 'Tournament Team Submitted',
            'message' => sprintf(
                '%s has submitted their team roster for the tournament "%s".',
                $opponentName,
